            ...
            */
			...
			changeColors: (index, color) => {
				...
				const demo = store.demo.map((elm, i) => {
					...
					const borrar = store.demo.filter(contenid => contenid.id == [elm.target.name]);
					setStore({ ...store.demo, demo: borrar });
					console.log(...store.demo, borrar);
					console.log(i);
					return elm;
				});
			...
			borrarElementoDeStore: elemento => {
				setStore({ lista: elemento });
			},
